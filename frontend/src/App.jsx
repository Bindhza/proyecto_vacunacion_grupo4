...
import HistorialPersonalAdmin from './HistorialPersonalAdmin'
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* ruta para historial de personal por admin */}
        <Route path="/admin/historial-personal" element={<HistorialPersonalAdmin />} />
      </Routes>
    </Router>
  )
}
