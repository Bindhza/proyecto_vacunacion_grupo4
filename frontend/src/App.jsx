    ...
    <div className="glass-container">
      ...
      {step === 1 && (
        <div>
          ...
          {campanas.length === 0 ? <p>No hay campañas vigentes en este momento.</p> : null}
          {campanas.map(c => (
      ...
      {step === 2 && (
        <div>
          ...
          {centros.length === 0 ? <p>No hay centros con cupos disponibles para esta campaña.</p> : null}
          {centros.map(c => (
      ...
      {step === 3 && (
        <div>
          ...
          {citas.length === 0 ? <p>No hay horarios disponibles.</p> : null}
          {citas.map(c => (
